...
Here are my solutions to the [Advent of Code](https://adventofcode.com/2025) puzzles for 2025.
...
- Put your test input into `input.txt`. This file is **not** tracked by `git`. Advent of Code asks that we not commit input files.
